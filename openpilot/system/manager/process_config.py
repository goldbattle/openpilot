...
procs = [
  # recorder fork: never phone home to comma. athenad is the control tunnel and uploader (below)
  # is the data path; both are off, so the SMB share in settings is the only egress.
  ...
  PythonProcess("uploader", "openpilot.system.loggerd.uploader", always_run, enabled=False),  # recorder fork: see athenad above
